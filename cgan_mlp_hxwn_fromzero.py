...
if __name__ == '__main__':
	...
	# param
	generator1 = G1_mlp_hxwn_datadim3000()
	generator2=G2_mlp_hxwn_datadim3000()
	discriminator = D_mlp_hxwn_datadim3000()

	#data = channel_hdx_plus_wn('mlp')
	data=channel_21h11w_plus_wn_shape500_20000('mlp')
